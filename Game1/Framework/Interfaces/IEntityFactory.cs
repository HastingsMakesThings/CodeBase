...
namespace Game1.Framework.Interfaces
{
    ...
    {
        IGameObject CreateGameObject<T>(float pX, float pY, IDictionary<string, IAnimation> pAnim, string pStartAnim, float pScale, Boolean pState) where T : IGameObject, new();
